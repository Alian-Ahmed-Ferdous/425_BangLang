...
public class banglangParser extends Parser {
	...
	public static final int
		...
		BOOL_LITERAL=30, STRING_LITERAL=31, WS=32, MULTIPLE_OP=33, ADD_OP=34, 
		CONDITION_OP=35, BOOLEAN_OP=36;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"STRING_LITERAL", "WS", "MULTIPLE_OP", "ADD_OP", "CONDITION_OP", "BOOLEAN_OP"
		};
	}
